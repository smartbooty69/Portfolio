...
export interface EducationSliceDefaultItem {
  ...
  /**
   * Course field in *Education → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: education.items[].course
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ExperienceSliceDefaultItem {
  ...
  /**
   * Employment Type field in *Experience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.items[].employment_type
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
